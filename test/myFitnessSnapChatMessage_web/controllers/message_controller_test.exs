defmodule MyFitnessSnapChatMessageWeb.MessageControllerTest do
  use MyFitnessSnapChatMessageWeb.ConnCase

  alias MyFitnessSnapChatMessage.ChatMessage
  alias MyFitnessSnapChatMessage.ChatMessage.Message

  @create_attrs %{text: "some text", timeout: 42, username: "some username"}
  ...
  def fixture(:message) do
    {:ok, message} = ChatMessage.create_message(@create_attrs)
    message
  end
